...
import { Pool as MySQLPool, PoolOptions } from 'mysql2';
import { Pool as PgPool } from 'pg';

import { LogMessage, LogMessageType, Encoding, Table, PgPoolConfig } from './types';
...
export default class Conversion {
     ...
     */
    public readonly _sourceConString: PoolOptions;

    /**
     * An object, representing target (PostgreSQL) db connection details.
     */
    public readonly _targetConString: PgPoolConfig;
    ...
    public constructor(
        ...
        this._mySqlDbName = this._sourceConString.database as string;
